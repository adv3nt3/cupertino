...
// Auto-generated raw-string-literal catalog; lint thresholds don't apply.
    ...
    public static let json: String = #"""
    {
      ...
      "entries": [
        ...
        },
        {
          ...
          "url": "/documentation/Accessibility/integrating-accessibility-into-your-app",
          "webURL": "https://developer.apple.com/documentation/Accessibility/integrating-accessibility-into-your-app",
          "zipFilename": "accessibility-integrating-accessibility-into-your-app.zip"
        },
        {
        ...
        {
          "description": "Show a specific area of a video by using timed display mask rectangle metadata.",
          "framework": "AVFoundation",
          "title": "Adding a display mask rectangle metadata track to a movie file",
          "url": "/documentation/AVFoundation/adding-a-display-mask-rectangle-metadata-track-to-a-movie-file",
          "webURL": "https://developer.apple.com/documentation/AVFoundation/adding-a-display-mask-rectangle-metadata-track-to-a-movie-file",
          "zipFilename": "avfoundation-adding-a-display-mask-rectangle-metadata-track-to-a-movie-file.zip"
        },
        {
        ...
        {
          "description": "Create a browser app and associated extensions.",
        ...
        },
        {
          ...
          "url": "/documentation/CryptoKit/storing-cryptokit-keys-in-the-keychain",
          "webURL": "https://developer.apple.com/documentation/CryptoKit/storing-cryptokit-keys-in-the-keychain",
          "zipFilename": "cryptokit-storing-cryptokit-keys-in-the-keychain.zip"
        },
        {
        ...
        {
          "description": "Support adding a virtual conference room to an event in Calendar.",
          "framework": "EventKit",
          "title": "Implementing a virtual conference extension",
          "url": "/documentation/EventKit/implementing-a-virtual-conference-extension",
          "webURL": "https://developer.apple.com/documentation/EventKit/implementing-a-virtual-conference-extension",
          "zipFilename": "eventkit-implementing-a-virtual-conference-extension.zip"
        },
        {
        ...
        },
        {
          ...
          "url": "/documentation/Foundation/building-a-localized-food-ordering-app",
          "webURL": "https://developer.apple.com/documentation/Foundation/building-a-localized-food-ordering-app",
          "zipFilename": "foundation-building-a-localized-food-ordering-app.zip"
        },
        {
        ...
        },
        {
          ...
          "url": "/documentation/Foundation/displaying-human-friendly-content",
          "webURL": "https://developer.apple.com/documentation/Foundation/displaying-human-friendly-content",
          "zipFilename": "foundation-displaying-human-friendly-content.zip"
        },
        {
          ...
          "url": "/documentation/Foundation/increasing-app-usage-with-suggestions-based-on-user-activities",
          "webURL": "https://developer.apple.com/documentation/Foundation/increasing-app-usage-with-suggestions-based-on-user-activities",
          "zipFilename": "foundation-increasing-app-usage-with-suggestions-based-on-user-activities.zip"
        },
        {
        ...
        },
        {
          ...
          "url": "/documentation/Foundation/synchronizing-app-preferences-with-icloud",
          "webURL": "https://developer.apple.com/documentation/Foundation/synchronizing-app-preferences-with-icloud",
          "zipFilename": "foundation-synchronizing-app-preferences-with-icloud.zip"
        },
        {
          ...
          "url": "/documentation/Foundation/using-json-with-custom-types",
          "webURL": "https://developer.apple.com/documentation/Foundation/using-json-with-custom-types",
          "zipFilename": "foundation-using-json-with-custom-types.zip"
        },
        {
        ...
        {
          "description": "Build a visionOS app that streams high-fidelity immersive content from a computer or the cloud using the Foveated Streaming framework.",
          "framework": "FoveatedStreaming",
          "title": "Creating a foveated streaming client on visionOS",
          "url": "/documentation/FoveatedStreaming/creating-a-foveated-streaming-client-on-visionos",
          "webURL": "https://developer.apple.com/documentation/FoveatedStreaming/creating-a-foveated-streaming-client-on-visionos",
          "zipFilename": "foveatedstreaming-creating-a-foveated-streaming-client-on-visionos.zip"
        },
        {
          "description": "Expose an existing path as its own file system by using the FSKit framework.",
          "framework": "FSKit",
          "title": "Building a passthrough file system",
          "url": "/documentation/FSKit/building-a-passthrough-file-system",
          "webURL": "https://developer.apple.com/documentation/FSKit/building-a-passthrough-file-system",
          "zipFilename": "fskit-building-a-passthrough-file-system.zip"
        },
        {
        ...
        {
          "description": "Build a shared photo gallery by using SharePlay to synchronize images among participants.",
          "framework": "GroupActivities",
          "title": "Creating a collaborative photo gallery with SharePlay",
          "url": "/documentation/GroupActivities/creating-a-collaborative-photo-gallery-with-shareplay",
          "webURL": "https://developer.apple.com/documentation/GroupActivities/creating-a-collaborative-photo-gallery-with-shareplay",
          "zipFilename": "groupactivities-creating-a-collaborative-photo-gallery-with-shareplay.zip"
        },
        {
        ...
        {
          "description": "Run concurrent blit commands and then a compute dispatch in a single pass with a unified compute encoder.",
          "framework": "Metal",
          "title": "Combining blit and compute operations in a single pass",
          "url": "/documentation/Metal/combining-blit-and-compute-operations-in-a-single-pass",
          "webURL": "https://developer.apple.com/documentation/Metal/combining-blit-and-compute-operations-in-a-single-pass",
          "zipFilename": "metal-combining-blit-and-compute-operations-in-a-single-pass.zip"
        },
        {
        ...
        {
          "description": "Dispatch model inference commands with a machine learning pass in a Metal 4 command buffer.",
          "framework": "Metal",
          "title": "Running a machine learning model on the GPU timeline",
          "url": "/documentation/Metal/running-a-machine-learning-model-on-the-gpu-timeline",
          "webURL": "https://developer.apple.com/documentation/Metal/running-a-machine-learning-model-on-the-gpu-timeline",
          "zipFilename": "metal-running-a-machine-learning-model-on-the-gpu-timeline.zip"
        },
        {
        ...
        },
        {
          ...
          "webURL": "https://developer.apple.com/documentation/Metal/using-metal-to-draw-a-view's-contents",
          "zipFilename": "metal-using-metal-to-draw-a-view's-contents.zip"
        },
        {
        ...
        {
          "description": "Configure and run a PIR server to support a URL filter using Apple\u2019s open source container tool.",
          "framework": "NetworkExtension",
          "title": "Setting up a PIR server for URL filtering",
          "url": "/documentation/NetworkExtension/setting-up-a-pir-server-for-url-filtering",
          "webURL": "https://developer.apple.com/documentation/NetworkExtension/setting-up-a-pir-server-for-url-filtering",
          "zipFilename": "networkextension-setting-up-a-pir-server-for-url-filtering.zip"
        },
        {
          "description": "Create the files a URL filter needs for its Bloom prefilter.",
          "framework": "NetworkExtension",
          "title": "Using the Bloom filter tool to configure a URL filter",
          "url": "/documentation/NetworkExtension/using-the-bloom-filter-tool",
          "webURL": "https://developer.apple.com/documentation/NetworkExtension/using-the-bloom-filter-tool",
          "zipFilename": "networkextension-using-the-bloom-filter-tool.zip"
        },
        {
        ...
        },
        {
          ...
          "url": "/documentation/PCIDriverKit/connecting-a-network-driver",
          "webURL": "https://developer.apple.com/documentation/PCIDriverKit/connecting-a-network-driver",
          "zipFilename": "pcidriverkit-connecting-a-network-driver.zip"
        },
        {
        ...
        },
        {
          ...
          "url": "/documentation/RealityKit/integrating-virtual-objects-with-your-environment",
          "webURL": "https://developer.apple.com/documentation/RealityKit/integrating-virtual-objects-with-your-environment",
          "zipFilename": "realitykit-integrating-virtual-objects-with-your-environment.zip"
        },
        {
        ...
        },
        {
          ...
          "url": "/documentation/Security/constraining-a-tool's-launch-environment",
          "webURL": "https://developer.apple.com/documentation/Security/constraining-a-tool's-launch-environment",
          "zipFilename": "security-constraining-a-tool's-launch-environment.zip"
        },
        {
        ...
        {
          "description": "Build a travel planning app that organizes trips into collections and tracks activity completion.",
          "framework": "SwiftUI",
          "title": "Wishlist: Planning travel in a SwiftUI app",
          "url": "/documentation/SwiftUI/wishlist-planning-travel-in-a-swiftui-app",
          "webURL": "https://developer.apple.com/documentation/SwiftUI/wishlist-planning-travel-in-a-swiftui-app",
          "zipFilename": "swiftui-wishlist-planning-travel-in-a-swiftui-app.zip"
        },
        {
        ...
        {
          "description": "Provide access to on-device and cloud files by adding a document browser to your app.",
          "framework": "UIKit",
          "title": "Building an app with a document browser",
          "url": "/documentation/UIKit/building-an-app-with-a-document-browser",
          "webURL": "https://developer.apple.com/documentation/UIKit/building-an-app-with-a-document-browser",
          "zipFilename": "uikit-building-an-app-with-a-document-browser.zip"
        },
        {
        ...
        {
          "description": "Substitute a person\u2019s hands with custom models in a fully immersive space.",
          "framework": "visionOS",
          "title": "Animating hand models in visionOS",
          "url": "/documentation/visionOS/animating-hand-models-in-visionOS",
          "webURL": "https://developer.apple.com/documentation/visionOS/animating-hand-models-in-visionOS",
          "zipFilename": "visionos-animating-hand-models-in-visionOS.zip"
        },
        {
        ...
        {
          "description": "Build an iPadOS companion app to control your visionOS app.",
          "framework": "visionOS",
          "title": "Connecting iPadOS and visionOS apps over the local network",
          "url": "/documentation/visionOS/connecting-ipados-and-visionos-apps-over-the-local-network",
          "webURL": "https://developer.apple.com/documentation/visionOS/connecting-ipados-and-visionos-apps-over-the-local-network",
          "zipFilename": "visionos-connecting-ipados-and-visionos-apps-over-the-local-network.zip"
        },
        {
        ...
        },
        {
          ...
          "webURL": "https://developer.apple.com/documentation/visionOS/displaying-a-3D-object-that-moves-to-stay-in-a-person's-view",
          "zipFilename": "visionos-displaying-a-3D-object-that-moves-to-stay-in-a-person's-view.zip"
        },
        {
        ...
        {
          "description": "Create a spatial stylus drawing experience that balances latency and accuracy for both in-air and on-surface drawing.",
          "framework": "visionOS",
          "title": "Drawing in the air and on surfaces with a spatial stylus",
          "url": "/documentation/visionOS/drawing-in-the-air-and-on-surfaces-with-a-spatial-stylus",
          "webURL": "https://developer.apple.com/documentation/visionOS/drawing-in-the-air-and-on-surfaces-with-a-spatial-stylus",
          "zipFilename": "visionos-drawing-in-the-air-and-on-surfaces-with-a-spatial-stylus.zip"
        },
        {
        ...
        {
          "description": "Enable collaborative spatial experiences by using SharePlay to synchronize 3D content among participants.",
          "framework": "visionOS",
          "title": "Implementing SharePlay for immersive spaces in visionOS",
          "url": "/documentation/visionOS/implementing-shareplay-for-immersive-spaces-in-visionos",
          "webURL": "https://developer.apple.com/documentation/visionOS/implementing-shareplay-for-immersive-spaces-in-visionos",
          "zipFilename": "visionos-implementing-shareplay-for-immersive-spaces-in-visionos.zip"
        },
        {
        ...
        {
          "description": "Extend the capabilities of your app by using entities, components, and systems to maintain solid collisions when manipulating entities.",
          "framework": "visionOS",
          "title": "Manipulating entities with solid collisions",
          "url": "/documentation/visionOS/manipulating-entities-with-solid-collisions",
          "webURL": "https://developer.apple.com/documentation/visionOS/manipulating-entities-with-solid-collisions",
          "zipFilename": "visionos-manipulating-entities-with-solid-collisions.zip"
        },
        {
        ...
        {
          "description": "Use Wi-Fi Infrastructure to automatically share Wi-Fi network credentials after establishing a Bluetooth connection.",
          "framework": "WiFiInfrastructure",
          "title": "Sharing Wi-Fi network credentials",
          "url": "/documentation/WiFiInfrastructure/Sharing-Wi-Fi-network-credentials",
          "webURL": "https://developer.apple.com/documentation/WiFiInfrastructure/Sharing-Wi-Fi-network-credentials",
          "zipFilename": "wifiinfrastructure-Sharing-Wi-Fi-network-credentials.zip"
        },
        {
